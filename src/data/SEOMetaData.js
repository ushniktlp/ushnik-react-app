const SeoMetadata = {
  home: {
    title:
      "Ushnik Technologies | IT Training, Internship & Placement in Hyderabad",
    description:
  ...
  about: {
    title: "About Ushnik Technologies | Career-Focused IT Training Institute",
    description:
  ...
  allCourses: {
    title: "IT Courses Offered | Python, UI/UX, AI ML, MERN, DevOps | Ushnik",
    description:
  ...
  certificate: {
    title: "Certification Programs | Industry-Recognized Certificates | Ushnik",
    description:
  ...
  internship: {
    title: "Internship Programs with Certification | Ushnik Technologies",
    description:
  ...
  placement: {
    title: "Placement Support & Career Assistance | Ushnik Technologies",
    description:
  ...
  schedule: {
    title: "Course Schedule & Batch Timings | Ushnik IT Training",
    description:
  ...
  contact: {
    title: "Contact Ushnik Technologies | IT Training Institute Hyderabad",
    description:
  ...
  uiux: {
    title: "UI/UX Design Course in Hyderabad | Ushnik Technologies",
    description:
  ...
  aiMl: {
    title: "AI & Machine Learning Course in Hyderabad | Ushnik",
    description:
  ...
  pythonFullStack: {
    title: "Python Full Stack Developer Course in Hyderabad | Ushnik",
    description:
  ...
  pythonAiMl: {
    title: "Python with AI & Machine Learning Course | Ushnik Technologies",
    description:
  ...
  mathsMl: {
    title: "Maths for Machine Learning Course | Ushnik Technologies",
    description:
  ...
  mern: {
    title: "MERN Stack Developer Course | MongoDB, React, Node | Ushnik",
    description:
